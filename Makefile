...
.PHONY: help deps lock run dev clean env docker-build logs

help:
	@echo "Targets: deps, deps-test, lock, docker-build, run, logs, dev, test, test-unit, test-integration, test-e2e, test-all, coverage, env, clean"
